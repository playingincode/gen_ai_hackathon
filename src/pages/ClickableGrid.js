...
function ClickableGrid() {
    ...
    const cards = [
        ...
        { id: 2, label: 'Exam Simulator', path: '/component2', color: 'linear-gradient(145deg, #03A9F4, #00BCD4)' },
        { id: 3, label: 'Ask EduBot', path: '/component3', color: 'linear-gradient(145deg, #03A9F4, #00BCD4)' },
        { id: 4, label: 'Upload Content', path: '/component4', color: 'linear-gradient(145deg, #03A9F4, #00BCD4)' },
        { id: 5, label: 'Fun Review', path: '/component5', color: 'linear-gradient(145deg, #03A9F4, #00BCD4)' },
